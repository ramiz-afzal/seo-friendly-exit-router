...
<div class="wrap">
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                <th scope="row">
                    <label for="<?= Functions::prefix('routing_delay'); ?>">Routing Delay</label>
                </th>
                <td>
                    <input type="number" min="1" step="1" name="<?= Functions::prefix('routing_delay'); ?>" id="<?= Functions::prefix('routing_delay'); ?>" value="<?= esc_attr(get_option(Functions::prefix('routing_delay'), Constant::ROUTING_DELAY)); ?>" class="regular-text" required>
                </td>
            </tr>
        </table>
        <?php submit_button(); ?>
